//для удобного потокового вывода текст.сообщений
#include <iostream>
//для создания потоков исполнения
#include <thread>
//для работы со строками
#include <string>
//для работы с временем - установкой временных задержек
#include <chrono>
//для обеспецения синхронизации и защиты разделяемых потоками данных
#include <mutex>
//удобный контейнер для реализации буфера
#include <queue>
//для обновления времени в генераторе случ.чисел
#include <ctime>
using namespace std;
